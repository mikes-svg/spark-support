...
export function SubmitRequestPage() {
  ...
  // max-h-full + internal scroll keeps the action bar on screen inside the
  // fixed-height app shell, even on short laptop viewports (e.g. 1440x900).
  return (
    <div className="max-w-2xl mx-auto max-h-full flex flex-col">
      <div className="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden flex flex-col min-h-0">
        <div className="shrink-0 px-6 py-5 border-b border-gray-200 bg-gray-50/50">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col min-h-0">
          ...
          <div className="shrink-0 px-6 py-4 flex items-center justify-end gap-4 border-t border-gray-200 bg-white">
            <Link to="/" className="inline-flex items-center justify-center py-2 px-4 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900">Cancel</Link>
